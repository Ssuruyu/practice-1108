...
var width = 1024;
var height = 768;
var ctrl = d3.select(".class1").append("svg").attr("width", width).attr("height", height);
d3.csv("https://pecu.github.io/practice-1108/stocks.csv",
      function(data) { console.log(data); });
d3.csv("https://pecu.github.io/practice-1108/stocks.csv/HistoricalQuotes.csv", 
	function(data)
	{
		var ln = data.length;
		console.log(data);
